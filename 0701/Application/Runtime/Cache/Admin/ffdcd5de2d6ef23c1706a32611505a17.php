...
<div class="divmain">
<form method="post" action="<?php echo U('admin/article/update_submit');?>">
    <div>
       <span>
           <label for="title">文章名</label>
       </span>
        <input type="hidden" name="aid" value="<?php echo ($cat['aid']); ?>">
        <span>
            <input id="title"  required name="title" value="<?php echo ($cat['title']); ?>"/>
        </span>
    </div>
    <div>
        <span>
        ...
        <span>
            <input id="author" name="author" value="<?php echo ($cat['author']); ?>"/>
        </span>
    </div>
    <div>
        <span>
    ...
    <div>
        ...
        <span>
            <textarea   id="content" name="content"  ><?php echo ($cat['content']); ?></textarea>
        </span>
    </div>
    <div>
        <span>
        ...
        <span>
            <input id="order" name="order" value="<?php echo ($cat['ord']); ?>">
        </span>
    </div>
    <div>
        <span>
        ...
        <span>
            <input type="radio" <?php echo ($cat['checkeyes']); ?> id="shown1" name="shown" value="1">是
            <input type="radio" <?php echo ($cat['checkedno']); ?> id="shown2" name="shown" value="0">否
        </span>
    </div>
    <div>
