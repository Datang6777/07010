...
<table align="center" style="margin-left: 200px;width: 60%">
    <tr colspan="2">
        <td>
            <img src="<?php echo ($data["logo"]); ?>" width="200" align="center"/>
        </td>
    </tr>
    <tr>
        <td></td>
        <td><a href="<?php echo U('Admin/User/uploadlogoqiniu');?>">七牛上传</a></a>
    </tr>
    <tr>
        <td></td>
        <td><a href="<?php echo U('Admin/User/uploadlogo');?>">原生上传</a></a>
    </tr>
    <tr>
        <td></td>
        <td><a href="<?php echo U('Admin/User/uploadlogotp');?>">TP上传</a></a>
    </tr>
    <tr>
        <td></td>
        <td><a href="<?php echo U('Admin/User/uploadlogoqnqd');?>">原生七牛上传前端</a></a>
    </tr>
    <tr>
        <td>用户编号</td>
    ...
    <tr>
        <td>性别</td>
        <td><?php echo ($data["gender"]?"女":"男"); ?></td>
    </tr>
    <tr>
        <td>用户名</td>
