...
<table align="center" style="margin-left: 200px;width: 60%">
    ...
    <tr>
        <td></td>
        <td><a href="<?php echo U('Home/User/uploadlogoqiniu');?>">七牛上传</a></a>
    </tr>
    <tr>
        <td></td>
        <td><a href="<?php echo U('Home/User/uploadlogo');?>">原生上传</a></a>
    </tr>
    <tr>
        <td></td>
        <td><a href="<?php echo U('Home/User/uploadlogotp');?>">TP上传</a></a>
    </tr>
    <tr>
        <td></td>
        <td><a href="<?php echo U('Home/User/uploadlogoqnqd');?>">原生七牛上传前端</a></a>
    </tr>
    <tr>
        <td>用户编号</td>
